...
export default function SubCategoriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const method = isAddingSubCategory ? 'POST' : 'PUT';
      ...
      if (isAddingSubCategory) {
        ...
        setSubCategories(subCategories.map(sc => sc._id === result._id ? result : sc));
      }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h1 className="text-3xl font-bold text-gray-800">Sub-Categories Management</h1>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">
              {isAddingSubCategory ? 'Add New Sub-Category' : `Edit Sub-Category: ${editingSubCategory?.title}`}
            </h2>
            <button
              onClick={resetForm}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              >
                {isAddingSubCategory ? 'Add Sub-Category' : 'Save Changes'}
              </button>
            </div>
          </form>
        </div>
